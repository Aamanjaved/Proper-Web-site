!function(t) {
            ...
            if (e)
                for (var s = 0, n = e.length; s < n; ++s) {
                    var i = e[s].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/)
                      , o = (o = (o = i[0]).toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"),
                    new RegExp(o))
                      , a = i[1] || ""
                      , h = i[3] || ""
                      , l = null
                      , i = i[2];
                    c.hasOwnProperty(i) && (l = c[i],
                    l = Number(r[l])),
                    null !== l && ("!" === a && (l = function(t, e) {
                        var s = "s"
                          , n = "";
                        t && (t = t.replace(/(:|;|\s)/gi, "").split(/\,/),
                        s = 1 === t.length ? t[0] : (n = t[0],
                        t[1]));
    ...
    function a(t, e, s) {
        ...
        this.$el.on("finish.countdown", s)) : this.options = n.extend({}, o, s)),
        this.setFinalDate(e),
    ...
    n.extend(a.prototype, {
        ...
        update: function() {
            var t, e, s;
            0 === this.$el.closest("html").length ? this.remove() : (t = void 0 !== n._data(this.el, "events"),
            e = new Date,
            s = this.finalDate.getTime() - e.getTime(),
            s = Math.ceil(s / 1e3),
            s = !this.options.elapse && s < 0 ? 0 : Math.abs(s),
            this.totalSecsLeft !== s && t && (this.totalSecsLeft = s,
    ...
    n.fn.countdown = function() {
        ...
        return this.each(function() {
            ...
            void 0 !== e ? (e = i[e],
            t = s[0],
            a.prototype.hasOwnProperty(t) ? e[t].apply(e, s.slice(1)) : null === String(t).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (e.setFinalDate.call(e, t),
            e.start()) : n.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, t))) : new a(this,s[0],s[1])
        })
    }
});
