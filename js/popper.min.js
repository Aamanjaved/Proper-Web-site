...
!function(e, t) {
    ...
    function P(e) {
        for (var t = g(e), n = r(e); n && 0 <= ["table", "td", "th"].indexOf(w(n)) && "static" === O(n).position; )
            n = r(n);
    ...
    function W(e, t) {
        ...
        o = C(e.scrollWidth, e.clientWidth, t ? t.scrollWidth : 0, t ? t.clientWidth : 0),
        r = C(e.scrollHeight, e.clientHeight, t ? t.scrollHeight : 0, t ? t.clientHeight : 0),
        i = -n.scrollLeft + h(i),
        n = -n.scrollTop,
        "rtl" === O(t || e).direction && (i += C(e.clientWidth, t ? t.clientWidth : 0) - o),
        e = A({
            width: o,
            height: r,
            x: i,
    ...
    function R(e, t) {
        t = void 0 === (t = (u = t = void 0 === t ? {} : t).placement) ? e.placement : t;
        var n, o, r, i, a, s, f, p = void 0 === (l = u.boundary) ? "clippingParents" : l, c = void 0 === (l = u.rootBoundary) ? "viewport" : l, l = void 0 === (l = u.elementContext) ? "popper" : l, d = void 0 !== (h = u.altBoundary) && h, u = H("number" != typeof (u = void 0 === (u = u.padding) ? 0 : u) ? u : I(u, q)), m = e.elements.reference, h = e.rects.popper, c = (n = b(d = e.elements[d ? "popper" === l ? "reference" : "popper" : l]) ? d : d.contextElement || x(e.elements.popper),
        r = c,
        o = "clippingParents" === (o = p) ? (a = L(D(i = n)),
        b(s = 0 <= ["absolute", "fixed"].indexOf(O(i).position) && v(i) ? P(i) : i) ? a.filter(function(e) {
        ...
        return function(t, o, n) {
            ...
            var i, a, l = {
                ...
                setOptions: function(e) {
                    ...
                    l.scrollParents = {
                        reference: b(t) ? L(t) : t.contextElement ? L(t.contextElement) : [],
                        popper: L(o)
                    },
                    n = c(function(e) {
                    ...
                    if (!d) {
                        ...
                        if (_(o, n = n.popper))
                            for (l.rects = {
                                ...
                                !f && a || ("body" === w(i) && !j(s) || (p = i !== g(i) && v(i) ? {
                                    scrollLeft: i.scrollLeft,
                                    scrollTop: i.scrollTop
                                } : m(i)),
                                v(i) ? ((c = y(i)).x += i.clientLeft,
                                c.y += i.clientTop) : s && (c.x = h(s))),
                                {
            ...
            return _(t, o) && u.setOptions(n).then(function(e) {
    ...
    function p(e) {
        var t, n, o, r, i = e.popper, a = e.popperRect, s = e.placement, f = e.offsets, p = e.position, c = e.gpuAcceleration, l = e.adaptive, d = (e = void 0 === (e = (t = e = !0 === (e = e.roundOffsets) ? (e = f.y,
        t = window.devicePixelRatio || 1,
        {
            x: V(V(f.x * t) / t) || 0,
            y: V(V(e * t) / t) || 0
        }) : "function" == typeof e ? e(f) : f).x) ? 0 : e,
        t = void 0 === (t = t.y) ? 0 : t,
        f.hasOwnProperty("x")), f = f.hasOwnProperty("y"), u = "left", m = "top", h = window;
        return l && (o = "clientHeight",
        r = "clientWidth",
        (n = P(i)) === g(i) && "static" !== O(n = x(i)).position && (o = "scrollHeight",
        r = "scrollWidth"),
        "top" === s && (m = "bottom",
        t = (t - (n[o] - a.height)) * (c ? 1 : -1)),
        "left" === s && (u = "right",
        e = (e - (n[r] - a.width)) * (c ? 1 : -1))),
        i = Object.assign({
            position: p
        }, l && G),
        c ? Object.assign({}, i, ((o = {})[m] = f ? "0" : "",
        o[u] = d ? "0" : "",
        o.transform = (h.devicePixelRatio || 1) < 2 ? "translate(" + e + "px, " + t + "px)" : "translate3d(" + e + "px, " + t + "px, 0)",
        o)) : Object.assign({}, i, ((s = {})[m] = f ? t + "px" : "",
        s[u] = d ? e + "px" : "",
        s.transform = "",
        s))
    }
    ...
    var q = ["top", "bottom", "right", "left"]
      ...
      , X = "beforeRead read afterRead beforeMain main afterMain beforeWrite write afterWrite".split(" ")
      , C = Math.max
      , N = Math.min
      , V = Math.round
      , Y = {
            ...
            !l.modifiersData[e]._skip) {
                ...
                [U(t), n, U(n)]) : [S(o)])
                  , p = [o].concat(a).reduce(function(e, t) {
                    ...
                    c = (a = 0 === (a = (e = p ? a ? z : z.filter(function(e) {
                        return e.split("-")[1] === p
                    }) : q).filter(function(e) {
                ...
                if (f)
                    ...
                    i = h ? 3 : 1; 0 < i && "break" !== r(i); i--)
                        ;
                l.placement !== y && (l.modifiersData[e]._skip = !0,
                l.placement = y,
                l.reset = !0)
            }
        },
      ...
      , Z = {
        ...
        fn: function(e) {
            var t = e.state
              , n = e.options;
            e = e.name;
            var o, r, i, a, s, f, p, c, l, d = void 0 === (m = n.mainAxis) || m, u = void 0 !== (m = n.altAxis) && m, m = void 0 === (m = n.tether) || m, h = n.tetherOffset, g = void 0 === h ? 0 : h, y = R(t, {
                boundary: n.boundary,
                rootBoundary: n.rootBoundary,
                padding: n.padding,
                altBoundary: n.altBoundary
            }), n = M(t.placement), b = t.placement.split("-")[1], v = !b, w = B(n), x = (n = "x" === w ? "y" : "x",
      ...
      , $ = {
        ...
        fn: function(e) {
            ...
            f && p && (s = H("number" != typeof (s = "function" == typeof (s = s.padding) ? s(Object.assign({}, i.rects, {
