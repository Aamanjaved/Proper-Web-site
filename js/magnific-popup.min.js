!function(e) {
    ...
    var f, o, g, i, h, t, l = "Close", v = "BeforeClose", y = "MarkupParse", C = "Open", A = "Change", n = "mfp", w = "." + n, b = "mfp-ready", F = "mfp-removing", r = "mfp-prevent-close", s = !!window.jQuery, I = c(window);
    c.magnificPopup = {
        instance: null,
        proto: e.prototype = {
            constructor: e,
            ...
            open: function(e) {
                ...
                if (!f.isOpen) {
                    ...
                    f.bgOverlay || (f.bgOverlay = u("bg").on("click" + w, function() {
                        f.close()
                    }),
                    ...
                    p("BeforeOpen"),
                    f.st.showCloseBtn && (f.st.closeBtnInside ? (d(y, function(e, t, n, o) {
                    ...
                    var r = f.wH = I.height()
                      , s = {}
                      , l = (f.fixedContentPos && f._hasScrollBar(r) && ((l = f._getScrollbarSize()) && (s.marginRight = l)),
            ...
            close: function() {
                f.isOpen && (p(v),
                f.isOpen = !1,
                f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(F),
                setTimeout(function() {
                    f._close()
            ...
            updateItemHTML: function() {
                ...
                (e = e.parsed ? e : f.parseEl(f.index)).type)
                  , n = (p("BeforeChange", [f.currItem ? f.currItem.type : "", t]),
                f.currItem = e,
                f.currTemplate[t] || (n = !!f.st[t] && f.st[t].markup,
                p("FirstMarkupParse", n),
                f.currTemplate[t] = !n || c(n)),
                i && i !== e.type && f.container.removeClass("mfp-" + i + "-holder"),
            ...
            updateStatus: function(e, t) {
                var n;
                f.preloader && (o !== e && f.container.removeClass("mfp-s-" + o),
                n = {
                    status: e,
            ...
            _parseMarkup: function(i, e, t) {
                ...
                c.each(e, function(e, t) {
                    if (void 0 === t || !1 === t)
                        return !0;
                    var n, o;
                    1 < (a = e.split("_")).length ? 0 < (n = i.find(w + "-" + a[0])).length && ("replaceWith" === (o = a[1]) ? n[0] !== t[0] && n.replaceWith(t) : "img" === o ? n.is("img") ? n.attr("src", t) : n.replaceWith(c("<img>").attr("src", t).attr("class", n.attr("class"))) : n.attr(a[1], t)) : i.find(w + "-" + e).html(t)
                })
            },
    ...
    c.fn.magnificPopup = function(e) {
        a();
        var t, n, o, i = c(this);
        return "string" == typeof e ? "open" === e ? (t = s ? i.data("magnificPopup") : i[0].magnificPopup,
        n = parseInt(arguments[1], 10) || 0,
        o = t.items ? t.items[n] : (o = i,
        (o = t.delegate ? o.find(t.delegate) : o).eq(n)),
        f._openClick({
            mfpEl: o
        }, i, t)) : f.isOpen && f[e].apply(f, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e),
    ...
    c.magnificPopup.registerModule(_, {
        ...
        proto: {
            ...
            getInline: function(e, t) {
                ...
                return j(),
                e.src ? (n = f.st.inline,
                (o = c(e.src)).length ? ((i = o[0].parentNode) && i.tagName && (k || (x = n.hiddenClass,
                k = u(x),
                x = "mfp-" + x),
                T = o.after(k).detach().removeClass(x)),
                f.updateStatus("ready")) : (f.updateStatus("error", n.tNotFound),
                o = c("<div>")),
                e.inlineElement = o) : (f.updateStatus("ready"),
                f._parseMarkup(t, {}, e),
                t)
            }
        }
        ...
        proto: {
            ...
            findImageSize: function(t) {
                function n(e) {
                    ...
                    z = setInterval(function() {
                        return 0 < i.naturalWidth ? void f._onImageHasSize(t) : (200 < o && clearInterval(z),
                        void (3 === ++o ? n(10) : 40 === o ? n(50) : 100 === o && n(500)))
                    }, e)
                }
                var o = 0
                  , i = t.img[0];
            ...
            getImage: function(e, t) {
                function n() {
                    ...
                    e.hasSize = !0,
                    e.loaded = !0,
                    p("ImageLoadComplete")) : ++a < 200 ? setTimeout(n, 100) : o())
                }
                function o() {
                ...
                var i, a = 0, r = f.st.image, s = t.find(".mfp-img");
                ...
                f.updateStatus("error", r.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"),
    ...
    function O(e) {
        var t;
        f.currTemplate[L] && (t = f.currTemplate[L].find("iframe")).length && (e || (t[0].src = "//about:blank"),
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var e, t, n, o, i, a, r = f.st.zoom, s = ".zoom";
                ...
                d("BuildControls" + s, function() {
                    f._allowZoom() && (clearTimeout(t),
                    f.content.css("visibility", "hidden"),
                    (e = f._getItemToZoom()) ? ((n = i(e)).css(f._getOffset()),
                    f.wrap.append(n),
        ...
        proto: {
            initGallery: function() {
                ...
                d("BuildControls" + e, function() {
                    var e, t;
                    1 < f.items.length && a.arrows && !f.arrowLeft && (t = a.arrowMarkup,
                    e = f.arrowLeft = c(t.replace(/%title%/gi, a.tPrev).replace(/%dir%/gi, "left")).addClass(r),
                    t = f.arrowRight = c(t.replace(/%title%/gi, a.tNext).replace(/%dir%/gi, "right")).addClass(r),
                    e.click(function() {
                        f.prev()
                    }),
                    t.click(function() {
            ...
            preloadNearbyImages: function() {
                for (var e = f.st.gallery.preload, t = Math.min(e[0], f.items.length), n = Math.min(e[1], f.items.length), o = 1; o <= (f.direction ? n : t); o++)
    ...
    c.magnificPopup.registerModule(H, {
        ...
        proto: {
            initRetina: function() {
                var n, o;
                1 < window.devicePixelRatio && (n = f.st.retina,
                o = n.ratio,
