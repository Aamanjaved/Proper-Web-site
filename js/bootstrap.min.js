!function(t, e) {
    ...
    "use strict";
    var s, i, l = (s = j) && s.__esModule ? s : (i = Object.create(null),
    s && Object.keys(s).forEach(function(t) {
        var e;
        "default" !== t && (e = Object.getOwnPropertyDescriptor(s, t),
    ...
    const g = {
      ...
      , o = t=>r(t) ? t.jquery ? t[0] : t : "string" == typeof t && 0 < t.length ? g.findOne(t) : null
      , c = (i,n,o)=>{
        Object.keys(o).forEach(t=>{
            var e = o[t]
              , s = n[t]
              , s = s && r(s) ? "element" : null == s ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
            if (!new RegExp(e).test(s))
                throw new TypeError(i.toUpperCase() + `: Option "${t}" provided type "${s}" but expected type "${e}".`)
        }
        )
    }
      ...
      , $ = (t,e,s,i)=>{
        let n = t.indexOf(e);
        return -1 === n ? t[!s && i ? t.length - 1 : 0] : (e = t.length,
        n += s ? 1 : -1,
        i && (n = (n + e) % e),
    ...
    function it(t, e, s, i, n) {
        i = tt(e[s], i, n);
        i && (t.removeEventListener(s, i, Boolean(n)),
        delete e[s][i.uidEvent])
    }
    function nt(t) {
    ...
    const b = {
        ...
        trigger(t, e, s) {
            ...
            return o && i && (r = i.Event(e, s),
            i(t).trigger(r),
            l = !r.isPropagationStopped(),
            c = !r.isImmediatePropagationStopped(),
            h = r.isDefaultPrevented()),
            a ? (d = document.createEvent("HTMLEvents")).initEvent(n, l, !0) : d = new CustomEvent(e,{
                bubbles: l,
                cancelable: !0
            }),
    ...
    b.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', E.handleDismiss(new E)),
    t(E);
    class w extends y {
        static get NAME() {
            return "button"
    ...
    const A = {
        ...
        getDataAttributes(s) {
            if (!s)
                return {};
            const i = {};
            return Object.keys(s.dataset).filter(t=>t.startsWith("bs")).forEach(t=>{
                let e = t.replace(/^bs/, "");
    ...
    class O extends y {
        ...
        pause(t) {
            t || (this._isPaused = !0),
            g.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (B(this._element),
            this.cycle(!0)),
        ...
        to(t) {
            ...
            t > this._items.length - 1 || t < 0 || (this._isSliding ? b.one(this._element, "slid.bs.carousel", ()=>this.to(t)) : e === t ? (this.pause(),
            this.cycle()) : (e = e < t ? T : C,
        ...
        _addTouchEventListeners() {
            ...
            this._pointerEvent ? (b.on(this._element, "pointerdown.bs.carousel", t=>e(t)),
            b.on(this._element, "pointerup.bs.carousel", t=>i(t)),
            this._element.classList.add("pointer-event")) : (b.on(this._element, "touchstart.bs.carousel", t=>e(t)),
            b.on(this._element, "touchmove.bs.carousel", t=>s(t)),
            b.on(this._element, "touchend.bs.carousel", t=>i(t)))
        }
        _keydown(t) {
            var e;
            /input|textarea/i.test(t.target.tagName) || (e = dt[t.key]) && (t.preventDefault(),
            this._slide(e))
        }
        _getItemIndex(t) {
            return this._items = t && t.parentNode ? g.find(".carousel-item", t.parentNode) : [],
        ...
        _triggerSlideEvent(t, e) {
            var s = this._getItemIndex(t)
              , i = this._getItemIndex(g.findOne(".active.carousel-item", this._element));
        ...
        _updateInterval() {
            const t = this._activeElement || g.findOne(".active.carousel-item", this._element);
            var e;
        ...
        _directionToOrder(t) {
            return [L, k].includes(t) ? m() ? t === k ? C : T : t === k ? T : C : t
        }
        _orderToDirection(t) {
            return [T, C].includes(t) ? m() ? t === C ? k : L : t === C ? L : k : t
        }
    ...
    b.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", O.dataApiClickHandler),
    ...
    class D extends y {
        constructor(t, s) {
            ...
            this._triggerArray = g.find(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`);
        ...
        show() {
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                let t, e;
                this._parent && (0 === (t = g.find(".show, .collapsing", this._parent).filter(t=>"string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains("collapse"))).length && (t = null));
                const i = g.findOne(this._selector);
                if (t) {
                    const g = t.find(t=>i !== t);
                    if ((e = g ? D.getInstance(g) : null) && e._isTransitioning)
                        return
                }
    ...
    b.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function(t) {
        ...
        g.find(e).forEach(t=>{
            ...
            let s;
            s = e ? (null === e._parent && "string" == typeof i.parent && (e._config.parent = i.parent,
    ...
    class I extends y {
        ...
        show() {
            if (!d(this._element) && !this._menu.classList.contains("show")) {
                ...
                if (!b.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (this._inNavbar)
                        A.setDataAttribute(this._menu, "popper", "none");
                    else {
                        if (void 0 === l)
                            throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                        let t = this._element;
                        "parent" === this._config.reference ? t = e : r(this._config.reference) ? t = o(this._config.reference) : "object" == typeof this._config.reference && (t = this._config.reference);
                        const s = this._getPopperConfig()
                          , i = s.modifiers.find(t=>"applyStyles" === t.name && !1 === t.enabled);
                        this._popper = l.createPopper(t, this._menu, s),
                        i && A.setDataAttribute(this._menu, "popper", "static")
                    }
                    "ontouchstart"in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach(t=>b.on(t, "mouseover", u)),
                    this._element.focus(),
        ...
        hide() {
            var t;
            !d(this._element) && this._menu.classList.contains("show") && (t = {
                relatedTarget: this._element
            },
        ...
        _completeHide(t) {
            b.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach(t=>b.off(t, "mouseover", u)),
            this._popper && this._popper.destroy(),
        ...
        _getPlacement() {
            ...
            var e;
            return t.classList.contains("dropend") ? vt : t.classList.contains("dropstart") ? yt : (e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(),
        ...
        _selectMenuItem({key: t, target: e}) {
            const s = g.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(h);
        ...
        static clearMenus(s) {
            if (!s || 2 !== s.button && ("keyup" !== s.type || "Tab" === s.key)) {
                ...
                for (let t = 0, e = i.length; t < e; t++) {
                    ...
                    if (g && !1 !== g._config.autoClose && g._element.classList.contains("show")) {
                        const n = {
                        ...
                        if (s) {
                            ...
                            if (i.includes(g._element) || "inside" === g._config.autoClose && !o || "outside" === g._config.autoClose && o)
                                continue;
                            if (g._menu.contains(s.target) && ("keyup" === s.type && "Tab" === s.key || /input|select|option|textarea|form/i.test(s.target.tagName)))
                                continue;
        ...
        static dataApiKeydownHandler(t) {
            if (/input|textarea/i.test(t.target.tagName) ? !("Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu"))) : pt.test(t.key)) {
                var e, s = this.classList.contains("show");
                if (s || "Escape" !== t.key)
                    if (t.preventDefault(),
                    t.stopPropagation(),
                    !d(this))
                        return e = ()=>this.matches('[data-bs-toggle="dropdown"]') ? this : g.prev(this, '[data-bs-toggle="dropdown"]')[0],
                        "Escape" === t.key ? (e().focus(),
                        void I.clearMenus()) : "ArrowUp" === t.key || "ArrowDown" === t.key ? (s || e().click(),
                        void I.getInstance(e())._selectMenuItem(t)) : void (s && "Space" !== t.key || I.clearMenus())
            }
        }
    }
    b.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', I.dataApiKeydownHandler),
    b.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", I.dataApiKeydownHandler),
    ...
    class At {
        ...
        _setElementAttributes(t, s, i) {
            ...
            this._applyManipulationCallback(t, t=>{
                var e;
                t !== this._element && window.innerWidth > t.clientWidth + n || (this._saveInitialAttribute(t, s),
        ...
        _resetElementAttributes(t, s) {
            this._applyManipulationCallback(t, t=>{
                ...
                void 0 === e ? t.style.removeProperty(s) : (A.removeDataAttribute(t, s),
                t.style[s] = e)
            }
            )
        }
    ...
    class N extends y {
        ...
        _adjustDialog() {
            var t = this._element.scrollHeight > document.documentElement.clientHeight
              ...
              , s = 0 < e;
            (!s && t && !m() || s && !t && m()) && (this._element.style.paddingLeft = e + "px"),
            (s && !t && !m() || !s && t && m()) && (this._element.style.paddingRight = e + "px")
        }
        _resetAdjustments() {
    ...
    b.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(t) {
        var e = n(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        d(this) || (b.one(e, "hidden.bs.offcanvas", ()=>{
            h(this) && this.focus()
        }
        ),
        (t = g.findOne(".offcanvas.show")) && t !== e && S.getInstance(t).hide(),
        S.getOrCreateInstance(e).toggle(this))
    }),
    b.on(window, "load.bs.offcanvas.data-api", ()=>g.find(".offcanvas.show").forEach(t=>S.getOrCreateInstance(t).show())),
    t(S);
            ...
            if (o.includes(n)) {
                ...
                r.forEach(t=>{
                    ((t,e)=>{
                        ...
                        if (e.includes(s))
                            return !Nt.has(s) || Boolean(St.test(t.nodeValue) || xt.test(t.nodeValue));
    ...
    class x extends y {
        ...
        show() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                const e = b.trigger(this._element, this.constructor.Event.SHOW)
                  , s = W(this._element)
                  , i = (null === s ? this._element.ownerDocument.documentElement : s).contains(this._element);
                if (!e.defaultPrevented && i) {
                    ...
                    const a = this._config["container"]
                      , r = (v(n, this.constructor.DATA_KEY, this),
                    this._element.ownerDocument.documentElement.contains(this.tip) || (a.appendChild(n),
                    b.trigger(this._element, this.constructor.Event.INSERTED)),
                    this._popper ? this._popper.update() : this._popper = l.createPopper(this._element, n, this._getPopperConfig(t)),
        ...
        hide() {
            if (this._popper) {
                ...
                var t;
                b.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented || (e.classList.remove("show"),
                "ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach(t=>b.off(t, "mouseover", u)),
        ...
        setElementContent(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = Mt(e, this._config.allowList, this._config.sanitizeFn)),
        ...
        _initializeOnDelegatedTarget(t, e) {
            ...
            return (e = e || ot(t.delegateTarget, s)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach(t=>{
                var e;
                "click" === t ? b.on(this._element, this.constructor.Event.CLICK, this._config.selector, t=>this.toggle(t)) : "manual" !== t && (e = "hover" === t ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                t = "hover" === t ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT,
                b.on(this._element, e, this._config.selector, t=>this._enter(t)),
                b.on(this._element, t, this._config.selector, t=>this._leave(t)))
            }
            ),
    ...
    class M extends y {
        ...
        refresh() {
            ...
            g.find(this._selector).map(t=>{
                const e = a(t)
                  , s = e ? g.findOne(e) : null;
                if (s) {
                    const t = s.getBoundingClientRect();
                    if (t.width || t.height)
                        return [A[i](s).top + n, e]
                }
                return null
            }
        ...
        _activate(e) {
            ...
            const t = this._selector.split(",").map(t=>t + `[data-bs-target="${e}"],${t}[href="${e}"]`)
              , s = g.findOne(t.join(","));
            s.classList.contains("dropdown-item") ? (g.findOne(".dropdown-toggle", s.closest(".dropdown")).classList.add("active"),
            s.classList.add("active")) : (s.classList.add("active"),
            g.parents(s, ".nav, .list-group").forEach(t=>{
                g.prev(t, ".nav-link, .list-group-item").forEach(t=>t.classList.add("active")),
                g.prev(t, ".nav-item").forEach(t=>{
                    g.children(t, ".nav-link").forEach(t=>t.classList.add("active"))
                }
                )
            }
            )),
        ...
        _clear() {
            g.find(this._selector).filter(t=>t.classList.contains("active")).forEach(t=>t.classList.remove("active"))
        }
        static jQueryInterface(e) {
            return this.each(function() {
    ...
    class P extends y {
        ...
        show() {
            if (!this._element.parentNode || this._element.parentNode.nodeType !== Node.ELEMENT_NODE || !this._element.classList.contains("active")) {
                ...
                if (i) {
                    const s = "UL" === i.nodeName || "OL" === i.nodeName ? ":scope > li > .active" : ".active";
                    t = (t = g.find(s, i))[t.length - 1]
                }
                var e = t ? b.trigger(t, "hide.bs.tab", {
                    relatedTarget: this._element
                }) : null;
        ...
        _activate(t, e, s) {
            const i = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g.children(e, ".active") : g.find(":scope > li > .active", e))[0]
              , n = s && i && i.classList.contains("fade")
              , o = ()=>this._transitionComplete(t, i, s);
            i && n ? (i.classList.remove("show"),
        ...
        _transitionComplete(t, e, s) {
            ...
            if ((i = i && "LI" === i.nodeName ? i.parentNode : i) && i.classList.contains("dropdown-menu")) {
                ...
                e && g.find(".dropdown-toggle", e).forEach(t=>t.classList.add("active")),
                t.setAttribute("aria-expanded", !0)
            }
            s && s()
        }
